...
if __name__ == '__main__':
    ...
    pd_train_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/STL-10/viT-L/models/vit_L_train_features_labels.csv',index=False,header=False)
    pd_test_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/STL-10/viT-L/models/vit_L_test_features_labels.csv',index=False,header=False)
    ...
    for each_shuffle in range(5):
        ...
        model.save_model(x,r'/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/STL-10/viT-L/models/kmeans_vit_L_'+str(each_shuffle)+'_model')
