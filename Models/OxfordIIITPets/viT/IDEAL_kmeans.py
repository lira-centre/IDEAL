...
def load_OxfordIIITPet_data(data_dir):
    '''
...
class IDEALClassifier:
    ...
    def PrototypesIdentification(self, Image,GlobalFeature,LABEL,CL,random_state):
        ...
        for i in range(0, CL+1):
            ...
            data[i] = normalize(data[i], axis=1, norm='l2')
    ...
    def DecisionMaking(self, Params,datates,NN=1):
        ...
        datates = normalize(datates, axis=1, norm='l2')
...
if __name__ == '__main__':
    ...
    # pd_train_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/OxfordIIITPets/viT/models/vit_train_features_labels.csv',index=False,header=False)
    # pd_test_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/OxfordIIITPets/viT/models/vit_test_features_labels.csv',index=False,header=False)
    ...
    for each_shuffle in range(5):
        ...
        # model.save_model(x,r'/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/OxfordIIITPets/viT/models/kmeans_vit_'+str(each_shuffle)+'_model')
