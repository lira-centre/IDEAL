...
def load_Caltech101_data(data_dir):
    '''
...
if __name__ == '__main__':
    ...
    datasete_imgs = Caltech101(
        root= './data', download=True, transform=transforms.ToTensor())

    trainset_imgs, testset_imgs = torch.utils.data.random_split(datasete_imgs, lengths, generator=generator)
    ...
    pd_train_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/Caltech101/viT/models/vit_train_features_labels.csv',index=False,header=False)
    pd_test_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/Caltech101/viT/models/vit_test_features_labels.csv',index=False,header=False)
    ...
    for each_shuffle in range(5):
        ...
        print("Prototypes as % of the Training Data Samples:", total_prototypes/len(train_features)*160, "%")
        ...
        model.save_model(x,r'/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/Caltech101/viT/models/kmeans_vit_'+str(each_shuffle)+'_model')
