...
class IDEALClassifier:
    ...
    def update_prototypes(self, Input, random_state):
...
if __name__ == '__main__':
    ...
    print("Train class numbers: ",np.unique(train_labels))
    print("Test class numbers: ",np.unique(test_labels))
    ...
    for run in range(10):
        ...
        for i in range(0, len(np.unique(test_labels))-1, 10):
            # Filter the training data for the current 10 classes
