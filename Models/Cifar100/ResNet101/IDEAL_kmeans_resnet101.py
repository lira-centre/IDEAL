...
class IDEALClassifier:
    ...
    def PrototypesIdentification(self, Image,GlobalFeature,LABEL,CL,random_state):
        ...
        for i in range(0, CL+1):
            ...
            kmeans = KMeans(n_clusters=250, random_state=random_state).fit(data[i])
...
if __name__ == '__main__':
    ...
    pd_train_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/update_on_cifar100/models/Resnet101_train_features_labels.csv',index=False,header=False)
    pd_test_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/update_on_cifar100/models/Resnet101_test_features_labels.csv',index=False,header=False)
    ...
    for each_shuffle in range(5):
        ...
        model.save_model(x,r'/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/update_on-cifar10/models/kmeans_resnet101_'+str(each_shuffle)+'_model')
