...
if __name__ == '__main__':
    ...
    pd_train_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/update_on-cifar10/models/vit_train_features_labels.csv',index=False,header=False)
    pd_test_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/update_on-cifar10/models/vit_test_features_labels.csv',index=False,header=False)
    ...
    for each_shuffle in range(5):
        ...
        model.save_model(x,r'/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/update_on-cifar10/models/kmeans_vit_'+str(each_shuffle)+'_model')
