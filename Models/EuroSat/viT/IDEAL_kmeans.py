...
def load_EuroSAT_data(data_dir):
    '''
...
if __name__ == '__main__':
    ...
    dataset = torchvision.datasets.EuroSAT(
        root= './data', download=False, transform=weights.transforms())

    generator = torch.Generator().manual_seed(42)
    trainset, testset = torch.utils.data.random_split(dataset, [21600, 5400], generator=generator)
    ...
    pd_train_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/EuroSat/viT/models/vit_train_features_labels.csv',index=False,header=False)
    pd_test_features_labels.to_csv('/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/EuroSat/viT/models/vit_test_features_labels.csv',index=False,header=False)
    ...
    for each_shuffle in range(5):
        ...
        model.save_model(x,r'/mmfs1/scratch/hpc/00/zhangz65/Code/IDEAL/code/EuroSat/viT/models/kmeans_vit_'+str(each_shuffle)+'_model')
